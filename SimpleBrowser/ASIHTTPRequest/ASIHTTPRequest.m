...
NSString *ASIHTTPRequestVersion = @"v1.8.1-36 2011-08-20";
...
- (BOOL)willRedirect
{
	...
	NSURL *newURL = [[NSURL URLWithString:[responseHeaders valueForKey:@"Location"] relativeToURL:[self url]] absoluteURL];
	if ([[newURL absoluteString] isEqualToString:[[self url] absoluteString]]) {
		return NO;
	}
