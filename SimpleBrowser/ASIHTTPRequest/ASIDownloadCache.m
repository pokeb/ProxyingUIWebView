...
- (void)updateExpiryForRequest:(ASIHTTPRequest *)request maxAge:(NSTimeInterval)maxAge
{
	...
	[cachedHeaders setObject:[[NSNumber numberWithDouble:[expires timeIntervalSince1970]] description] forKey:@"X-ASIHTTPRequest-Expires"];
...
- (void)storeResponseForRequest:(ASIHTTPRequest *)request maxAge:(NSTimeInterval)maxAge
{
	...
	NSDate *expires = [self expiryDateForRequest:request maxAge:maxAge];
	if (expires) {
		[responseHeaders setObject:[[NSNumber numberWithDouble:[expires timeIntervalSince1970]] description] forKey:@"X-ASIHTTPRequest-Expires"];
	}
	...
	[responseHeaders setObject:[[NSNumber numberWithInt:statusCode] description] forKey:@"X-ASIHTTPRequest-Response-Status-Code"];
